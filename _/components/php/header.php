    ...
    <header class="clearfix">
      ...
      <section class="navbar">
       <ul class="nav navbar-nav">
        ...
        <li class="nav-item"> <a href="venuetravel.php">Venue</a></li>
        <li class="nav-item"> <a href="schedule.php">Schedule</a></li>
        <li  class="dropdown">
        
          <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Artist <span class="caret"></span></a>
