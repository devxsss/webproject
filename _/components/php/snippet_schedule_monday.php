...
<div class="decor2">
	...
	<section class="media">
	  ...
	  <div class="media">
		<a href="artists.php#LaVonne_LaRue" class="pull-left" data-toggle="tooltip" title data-original-title="LaVonne LaRue"><img class="img-rounded" src="images/artists/LaVonne_LaRue_tn.jpg" alt="Photo of LaVonne LaRue"></a>
			<h2 class="animationid">Art in Unexpected Places</h2>
			<div class="hoverbutton2">
	...
	<section class="media">
	  ...
	  <div class="media-body">
		<a href="artists.php#Lorenzo_Garcia" class="pull-left" data-toggle="tooltip" title data-original-title="Lorenzo Garcia"><img class="pull-left img-rounded" src="images/artists/Lorenzo_Garcia_tn.jpg" alt="Photo of Lorenzo Garcia"></a>
			<h2 class="animationid">Art in Full Bloom</h2>
			<div class="hoverbutton2">
  ...
  <div class="decor2">
	...
	<div class="media-body" >
	<a href="artists.php#Lorenzo_Garcia" class="pull-left" data-toggle="tooltip" title="Jonathan Ferrar" ><img class="pull-left img-rounded" src="images/artists/Jonathan_Ferrar_tn.jpg" alt="Photo of Lorenzo Garcia"></a>
			<h3 class="animationid">Still Life</h3>
			<div class="hoverbutton2">
			<h4>Dennison Hall</h4>
